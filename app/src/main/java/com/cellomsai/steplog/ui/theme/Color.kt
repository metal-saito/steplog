...
// Material3 roles – Light
val md_theme_light_primary = PrimarySage
val md_theme_light_onPrimary = Color(0xFFFFFFFF)
val md_theme_light_primaryContainer = Color(0xFFD4E8D2)
val md_theme_light_onPrimaryContainer = Color(0xFF1A3019)
val md_theme_light_secondary = SecondaryFuji
val md_theme_light_onSecondary = Color(0xFFFFFFFF)
val md_theme_light_secondaryContainer = Color(0xFFE8E3F5)
val md_theme_light_onSecondaryContainer = Color(0xFF2A2040)
val md_theme_light_background = BackgroundCream
...
val md_theme_light_outline = DividerSoft
